...
public class Adding extends Application {
    ...
    public void start(Stage stage){
        ...
        stage.show();
    }private boolean linkTaskToTag(int taskId, String tagTitle) throws SQLException {
    ...
    private int insertTaskToDatabase(String taskName, String taskDescription, String taskDate) throws SQLException {
        Database database = Database.getInstance();
        Connection connection = Database.getConnection();
